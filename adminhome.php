...
<body>
    ...
    <div class="container mt-5">
        <div>
            <?php
                    echo"<h3>New Service Request:</h3>";
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Business Identification Number: '.$bin.'</p>
            ...
            <button class="btn btn-success mx-2 my-2 my-sm-0" type="submit" name="approved"> <a
                    href="approve_service.php?id='.$org_id.' " style="color:#ffffff;">
                    Approve </a></button>
                   </form>
                   <form method="post" action="">

            <button class=" btn btn-danger mx-2 my-2 my-sm-0" type="submit" name="rejected"> <a
                    href="reject_service.php?id='.$org_id.'" style="color:#ffffff;">
                    Reject</a></button>
                   </form>
                   </div>
                   </div>
